...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.TagsList != nil {
		f11 := []*svcsdk.Tag{}
		for _, f11iter := range r.ko.Spec.TagsList {
			f11elem := &svcsdk.Tag{}
			if f11iter.Key != nil {
...
func (rm *resourceManager) sdkUpdate(
	...
	var resp *svcsdk.UpdateTrailOutput
	_ = resp
	resp, err = rm.sdkapi.UpdateTrailWithContext(ctx, input)
...
func (rm *resourceManager) newUpdateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.UpdateTrailInput, error) {
	res := &svcsdk.UpdateTrailInput{}
