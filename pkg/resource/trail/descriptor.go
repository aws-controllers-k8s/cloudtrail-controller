...
const (
	finalizerString = "finalizers.cloudtrail.services.k8s.aws/Trail"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("trails")
