...
const (
	finalizerString = "finalizers.cloudtrail.services.k8s.aws/EventDataStore"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("eventdatastores")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.EventDataStore{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.EventDataStore),
	}
}
