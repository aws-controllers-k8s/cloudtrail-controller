...
import (
	...
	svcsdkapi "github.com/aws/aws-sdk-go/service/cloudtrail/cloudtrailiface"
...
// +kubebuilder:rbac:groups=cloudtrail.services.k8s.aws,resources=eventdatastores,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudtrail.services.k8s.aws,resources=eventdatastores/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"AdvancedEventSelectors"}
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.CloudTrailAPI
}
...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.AdvancedEventSelectors == nil {
		return true
	}
	return false
}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.AdvancedEventSelectors != nil && latestKo.Spec.AdvancedEventSelectors == nil {
		latestKo.Spec.AdvancedEventSelectors = observedKo.Spec.AdvancedEventSelectors
	}
