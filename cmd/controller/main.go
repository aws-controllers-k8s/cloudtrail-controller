...
import (
	...
	_ "github.com/aws-controllers-k8s/cloudtrail-controller/pkg/resource/event_data_store"
...
var (
	awsServiceAPIGroup = "cloudtrail.services.k8s.aws"
	awsServiceAlias    = "cloudtrail"
