...
// +kubebuilder:rbac:groups=cloudtrail.services.k8s.aws,resources=trails,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudtrail.services.k8s.aws,resources=trails/status,verbs=get;update;patch
